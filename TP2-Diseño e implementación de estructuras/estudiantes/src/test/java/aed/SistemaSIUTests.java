...
public class SistemaSIUTests {
    ...
    @Test
    void nadie_excede_hayCupo() {
        SistemaSIU sistema = new SistemaSIU(infoMaterias, estudiantes);
        assertFalse(sistema.excedehayCupo("Algoritmos1", "Ciencias de Datos"));
        assertFalse(sistema.excedehayCupo("Intro a la Programación", "Ciencias de la Computación"));
        assertFalse(sistema.excedehayCupo("Análisis I", "Ciencias de la Computación"));
        assertFalse(sistema.excedehayCupo("Análisis I", "Ciencias de Datos"));
        assertFalse(sistema.excedehayCupo("Matemática 1", "Ciencias Físicas"));
        assertFalse(sistema.excedehayCupo("Análisis Matemático I", "Ciencias Químicas"));
        assertFalse(sistema.excedehayCupo("Análisis I", "Ciencias Matemáticas"));
        assertFalse(sistema.excedehayCupo("Química General e Inorgánica 1", "Ciencias Biológicas"));
        assertFalse(sistema.excedehayCupo("Química General", "Ciencias Químicas"));
        assertFalse(sistema.excedehayCupo("Algoritmos2", "Ciencias de Datos"));
        assertFalse(sistema.excedehayCupo("Análisis II", "Ciencias de Datos"));
    }
    ...
    void colapsar_facultad() {
        ...
        assertTrue(sistema.excedehayCupo("Intro a la Programación", "Ciencias de la Computación"));
        ...
        assertTrue(sistema.excedehayCupo("Algoritmos2", "Ciencias de Datos"));
        assertTrue(sistema.excedehayCupo("Técnicas de Diseño de Algoritmos", "Ciencias de la Computación"));
        assertTrue(sistema.excedehayCupo("Química General e Inorgánica 1", "Ciencias Biológicas"));
        assertFalse(sistema.excedehayCupo("Análisis II", "Ciencias Matemáticas"));
    }
    ...
    void cerrar_facultad() {
        ...
        String[] k = sistema.materias("Ciencias de la Computación");
        k = sistema.materias("Ciencias de Datos");
        assertArrayEquals(materiasCompu, sistema.materias("Ciencias de la Computación"));
